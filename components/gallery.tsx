...
const imagesRow1 = [
  {
    ...
    height: 210,
    className:
      "object-cover w-[278px] h-[183px] lg:w-[406px] lg:h-[210px] flex-none",
  },
  {
    ...
    height: 298,
    className:
      "object-cover w-[180px] h-[183px] lg:w-[256px] lg:h-[298px] flex-none",
  },
  {
    ...
    height: 235,
    className:
      "object-cover w-[410px] h-[222px] lg:w-[551px] lg:h-[235px] flex-none",
  },
  {
    ...
    height: 235,
    className:
      "object-cover w-[200px] h-[257px] lg:w-[259px] lg:h-[235px] flex-none",
  },
  {
    src: "/sajjad_imanian_6.jpg",
    width: 406,
    height: 210,
    className:
      "object-cover w-[200px] h-[257px] lg:w-[406px] lg:h-[210px] flex-none",
  },
];
...
const imagesRow2 = [
  {
    ...
    height: 210,
    className:
      "object-cover w-[380px] h-[238px] lg:w-[466px] lg:h-[210px] flex-none",
  },
  {
    ...
    height: 177,
    className:
      "object-cover w-[240px] h-[300px] lg:w-[214px] lg:h-[177px] flex-none",
  },
  {
    ...
    height: 245,
    className:
      "object-cover w-[463px] h-[257px] lg:w-[394px] lg:h-[245px] flex-none",
  },
  {
    ...
    height: 267,
    className:
      "object-cover w-[257px] h-[214px] lg:w-[214px] lg:h-[267px] flex-none",
  },
  {
    src: "/sajjad_imanian_8.jpg",
    width: 466,
    height: 210,
    className:
      "object-cover w-[257px] h-[214px] lg:w-[466px] lg:h-[210px] flex-none",
  },
  {
    src: "/sajjad_imanian_8.jpg",
    width: 214,
    height: 177,
    className:
      "object-cover w-[257px] h-[214px] lg:w-[214px] lg:h-[177px] flex-none",
  },
];

...
const About = () => (
  <section className="pt-[104px] pb-7">
    <div className="container">
      <article>
        ...
        <header>
          <h2 className="font-bold text-[#272727] text-[42px] leading-[44px] clear-none pt-[246px]">
      ...
      <aside className="w-full flex justify-end mt-20">
        <div className="max-w-[calc(390px+114px+114px)] py-[27px] px-[114px] text-center">
